...
export default function CalendertEditDrawerComponenet({ inOpen, setIsOpen }) {
  const onClose = () => {
    setIsOpen(false);
  };

  return (
    <Transition.Root show={inOpen} as={Fragment}>
      <Dialog as="div" auto-reopen="true" className="fixed inset-0 overflow-hidden z-50" onClose={onClose}>
